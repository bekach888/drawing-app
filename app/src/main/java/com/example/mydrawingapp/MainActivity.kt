...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnStoragePermission = findViewById<ImageButton>(R.id.ib_image)
        ...
        mImageButtonCurrentPaint = linearLayoutPainColors[0] as ImageButton
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            permissions.entries.forEach {
                ...
                if (isGranted) {
                    ...
                    openGalleryLauncher?.launch(pickIntent) // Use openGalleryLauncher with safe call
                    // ...
                } else {
